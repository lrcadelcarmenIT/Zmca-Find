(() => {
  ...
  // Key is sent as a header (X-goog-api-key) rather than a ?key= query param.
  // New-format "AQ." Gemini keys have been returning 401 ACCESS_TOKEN_TYPE_UNSUPPORTED
  // via the query param for some accounts; the header form is the documented alternative.
